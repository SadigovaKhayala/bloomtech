...
const translations = {
  AZ: {
    ...
    credoPoints: [
      ...
      "Yeni rəqəmsal format və daha artığı",
    ],
    bloomTitle: "Bloom",
    bloomSubtitle: "Alış-verişdə çatdırılmanı daha asan etdik.",
    bloomPoints: [
      "Hədiyyələr və aksesuarların sifarişi, çatdırılması  və izlənməsi bir toxunuşda",
    ],
    ...
    bloomRestPoints: [
      "Asan rezervasiya",
      "Öncədən sifariş",
      "Yenilənmiş reytinq sistemi daha çoxu tətbiqdə bir toxunuşla",
    ],
  },
  EN: {
    aboutUs: "About Us",
