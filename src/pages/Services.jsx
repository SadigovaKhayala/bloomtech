...
const translations = {
  AZ: {
    ...
    servicesList: [
      {
        title: "Mobil tətbiqin yaradılması",
        description:
      ...
      },
      {
        ...
        description:
          "IT sferasında həm hardware həm software problemlərinin aradan qaldırılması və lazımi qurğuların sazlanması",
      },
      {
        title: "Digital Marketing",
        description:
          "Peşəkar SMM, SMO, SEO və Motion dizaynerlərimiz xidmətinizdə.",
      },
      {
